...
Example outputs: 
- feat(core): add mana interface for players 
- fix(magic): resolve crash when casting fire spell 
- refactor(server): convert main launcher to kotlin chore: update gradle wrapper to version 8.5
